...
describe('Awespottr', function () {
  ...
  it('does an all-region lookup with a single instance type', async function () {
  ...
  it('does a all-region lookup with multiple instance types', async function () {
  ...
  it('does a single-region lookup with a single instance type', async function () {
  ...
  it('does a single-region lookup with multiple instance types', async function () {
  ...
  it('does a single-region lookup with multiple instance types limited to the top 3', async function () {
